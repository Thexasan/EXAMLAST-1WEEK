    ...
    <div>
      <section className='max-w-[100%] mt-[20px]'>
        ...
        <div className="ml-[5%]">
            ...
            <div>
              <h1 className='text-[18px] font-[700] text-[#333]'>Работа в OOO «БелКопроСтрой» (текст для примера)</h1>
...
Вы можете добиться успеха на любой из множества должностей. Наша компания придерживается клиентоориентированных принципов работы, и мы всегда ищем людей, которые принесут нам пользу и сделают наши услуги еще лучше.</p>
            ...
            <div>
              <h1 className='text-[18px] font-[700] text-[#333]'>Что значит работать в SVAI.BY</h1>
          ...
          <h1 className='text-[24px] pb-[100px] font-[700] text-[#333333]'>В настоящий момент вакансий нет</h1>
        </div>
        <div>
        </div>
        </div>
